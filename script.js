document.addEventListener('DOMContentLoaded', function() {
  ...
  document.addEventListener('click', function(e) {
    if (navMenu && navMenu.classList.contains('active') && !e.target.closest('.navbar') && !e.target.closest('.menu-toggle')) {
  ...
  function setupMobileCarousel(gridSelector, controlsSelector, dotsSelector) {
    ...
    function scrollToItem(index) {
      if (items[index]) {
        ...
        const scrollLeft = items[index].offsetLeft - (gridWidth - itemWidth) / 2;
  ...
  function initMobileCarousels() {
    if (window.innerWidth <= 768) {
      setupMobileCarousel('.services-grid', '.services-controls', '.services-dots');
      setupMobileCarousel('.projects-grid', '.projects-controls', '.projects-dots');
      setupMobileCarousel('.partners-grid', '.partners-controls', '.partners-dots');
    }
  }
  ...
  const carousels = document.querySelectorAll('.services-grid, .projects-grid, .partners-grid');
